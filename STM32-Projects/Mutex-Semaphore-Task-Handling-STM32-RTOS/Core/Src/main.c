...
/* Definitions for My_FirstTask */
osThreadId_t My_FirstTaskHandle;
const osThreadAttr_t My_FirstTask_attributes = {
  .name = "My_FirstTask",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
/* Definitions for My_SecondTask */
osThreadId_t My_SecondTaskHandle;
const osThreadAttr_t My_SecondTask_attributes = {
  .name = "My_SecondTask",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityLow,
};
...
/* USER CODE BEGIN Header_My_FirstFunction */
/**
* @brief Function implementing the My_FirstTask thread.
* @param argument: Not used
* @retval None
*/
...
void My_FirstFunction(void *argument)
{
  ...
  /* USER CODE END My_FirstFunction */
}

/* USER CODE BEGIN Header_My_SecondFunc */
/**
* @brief Function implementing the My_SecondTask thread.
* @param argument: Not used
* @retval None
*/
...
void My_SecondFunc(void *argument)
{
  ...
  /* USER CODE END My_SecondFunc */
}

/* USER CODE BEGIN Header_Transmit_Func */
/**
...
/*
	  ...
	  {
		  osThreadSuspend(TransmitterTaskHandle);
		  tim_val = HAL_GetTick();
	  }
	  */

  }
  /* USER CODE END Transmit_Func */
}

/* USER CODE BEGIN Header_Receive_Func */
/**
...
void Receive_Func(void *argument)
{
 ...
 /* if (HAL_GetTick()-tim_val >= 10000)
  {
	  osThreadResum(TransmitterTaskHandle);
  }*/

  /* USER CODE END Receive_Func */
}
