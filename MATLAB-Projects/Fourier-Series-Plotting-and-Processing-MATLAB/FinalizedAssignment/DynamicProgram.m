...
wtS=wt_+wt2+wt3+wt4+wt5+wt6+wt7+wt8+wt9+wt10+wt11+wt12+wt_+wt2_+wt3_+wt4_+wt5_+wt6_+wt7_+wt8_+wt9_+wt10_+wt11_
wtSAB=abs(wtS)
plot(t , wtSAB , t , y)
title('Approximation of Triangle(t/2) using Fourier Series Coefficients')
ylabel('w(t)')
grid on
